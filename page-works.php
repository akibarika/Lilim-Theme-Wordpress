        ...
        <section id="single" class="wrap-work page">
            ...
            <div class="work-content right">
                        ...
                        <article class="work-here">
                            <div class="wrap">
                                <div class="work-thumb">
                                    ...
                                    <div class="caption">
                                        <a class="button web" href="<?php echo $link; ?>" target="_blank" ><span>visit</span></a>
                                    </div>
                                </div>
                                <div class="work-info">
                                    <div class="work-title"><a href="<?php echo $link; ?>" target="_blank"><span><?php the_title(); ?></span></a> </div>
                        ...
                        <article class="work-here">
                            <div class="wrap">
                                <div class="work-thumb">
                                    ...
                                    <div class="caption">
                                        <a class="button theme" href="<?php echo $link; ?>" target="_blank" ><span>private</span></a>
                                    </div>
                                </div>
                                <div class="work-info">
                                    <div class="work-title"><a href="<?php echo $link; ?>" target="_blank"><span><?php the_title(); ?></span></a> </div>
                ...
                <div class="work-container">
                    ...
                    <?php
                        $args = array('post_type'=>'illustration');
                        query_posts($args);
                        if( have_posts() ) :
                    ?>
                    <div class="content-list">
                        ...
                        <article class="work-here">
                            <div class="wrap">
                                <div class="work-thumb">
                                    ...
                                    <div class="caption">
                                        <a class="button drawing" href="<?php echo $link; ?>" target="_blank" ><span>browse</span></a>
                                    </div>
                                </div>
                                <div class="work-info">
                                    <div class="work-title"><a href="<?php echo $link; ?>" target="_blank"><span><?php the_title(); ?></span></a> </div>
