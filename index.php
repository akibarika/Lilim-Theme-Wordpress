<?php get_header(); ?>	
				<ul>
					<li><?php next_posts_link('<i class="fa-chevron-right fa-3x"></i><span class="pagenav">下一页</span>', 0); ?></li>
					<li><?php previous_posts_link('<i class="fa-chevron-left fa-3x"></i><span class="pagenav">上一页</span>', 0); ?></li>
				</ul>	
				<ul>
